...
<head>
  ...
  <title>Shipstar - Arrived Orders</title>
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Arrived Orders</h5>
              ...
              <table class="table datatable" id="jj">
                ...
                <tbody>
				<?php 
$stmt = $conn->prepare("SELECT * FROM `orders` where status ='Collected by Shippii' ");
...
?>
                  <tr>
                   ...
                   <td><?php echo $row['dcountry'].", ".$row['droptown'].", ".$row['drop_off_address']; ?></td>
