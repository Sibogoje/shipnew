...
<head>
  ...
  <title>Locker - South Africa</title>
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">SA Orders</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">SA Orders</h5>
              ...
              <table class="table datatable" id="jj">
                <thead>
                    ...
                    <th scope="col">Con. Person Phone</th>
                    ...
                    <th scope="col">Driver Company</th>
          ...
          <th scope="col" colspan="1" >Action</th>
                ...
                <tbody>
        <?php 
$stmt = $conn->prepare("SELECT * FROM `deliver_package` where `status` = 'South Africa' ");
...
//$rr  =  date('Y-m-d', $date);
  $fulladdress = $row['country']." ".$row['region']." ".$row['town']." ".$row['street']." ".$row['home']." ".$row['landmark'];
?>
