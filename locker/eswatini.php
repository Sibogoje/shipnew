    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Eswatini</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Eswatini Orders</h5>
          ...
          <th scope="col" colspan="1" >Action</th>
                ...
                <tbody>
        <?php 
$stmt = $conn->prepare("SELECT * FROM `deliver_package` where `status` = 'Eswatini' ");
