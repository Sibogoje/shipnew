...
<head>
  ...
  <title>Warehouse - All Orders</title>
          ...
          <div class="card">
            <div class="card-body">
              ...
              <table class="table datatable" id="jj">
                ...
                <tbody>
				<?php 
$stmt = $conn->prepare("SELECT * FROM `all_warehouse`");
...
?>
                  <tr>
                   ...
                   <td><?php echo $row['description']; ?></td>
					...
					<td>
			<button type="button" data-link="dedit.php?id=<?php echo $row['orderno']; ?>" title="View" class="btn btn-warning edit" data-id="<?php echo $row['orderno']; ?>"><i class="bi bi-eye-fill"></i></button>
