          ...
          <div class="card">
            <div class="card-body">
              ...
              <table class="table datatable" id="jj">
                ...
                <tbody>
				<?php 
$stmt = $conn->prepare("SELECT * FROM `warehouse` where status ='arrived' ");
...
?>
                  <tr>
                    <th scope="row"><?php echo $row['parcel_id']; ?></th>
                    <td><?php echo $row['email']; ?></td>
                    <td><?php echo $row['parcel_desc']; ?></td>
                   <td><?php echo $row['country'].", ".$row['town'].", ".$row['address']; ?></td>
