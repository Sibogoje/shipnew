...
<head>
  ...
  <title>Warehouse - Checked Into Locker</title>
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Checked Into Locker</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Checked Into Locker</h5>
              ...
              <table class="table datatable" id="jj">
                ...
                <tbody>
        <?php 
$stmt = $conn->prepare("SELECT * FROM `shipster_locker` ");
